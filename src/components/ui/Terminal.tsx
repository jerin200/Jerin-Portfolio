...
export function Terminal({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "mx-auto w-[85%] sm:w-full max-w-md sm:max-w-xl px-2 sm:px-4 font-mono text-[10px] sm:text-xs",
        className
      )}
    >
      <div className="overflow-hidden rounded-lg border border-neutral-800 bg-neutral-900 shadow-2xl">
        {/* Title Bar */}
        <div className="flex items-center gap-2 bg-neutral-800 px-3 sm:px-4 py-2 sm:py-3">
          <div className="flex items-center gap-1.5">
            <div className="h-2 w-2 sm:h-3 sm:w-3 rounded-full bg-red-500 transition-colors hover:bg-red-600" />
            <div className="h-2 w-2 sm:h-3 sm:w-3 rounded-full bg-yellow-500 transition-colors hover:bg-yellow-600" />
            <div className="h-2 w-2 sm:h-3 sm:w-3 rounded-full bg-green-500 transition-colors hover:bg-green-600" />
          </div>
          <div className="flex-1 text-center">
            <span className="truncate text-[9px] sm:text-xs text-neutral-400">
              {username} — bash
            </span>
          </div>
        ...
        <div
          ref={contentRef}
          className="no-visible-scrollbar h-60 sm:h-80 overflow-y-auto p-3 sm:p-4 font-mono"
        >
          {lines.map((line, i) => (
