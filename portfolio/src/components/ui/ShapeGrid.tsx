...
const ShapeGrid: React.FC<ShapeGridProps> = ({
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // Perfectly fade out the grid using compositing so it doesn't darken the beautiful SoftAurora background
      ...
      gradient.addColorStop(0, 'rgba(255, 255, 255, 1)');     // Fully visible in center
      gradient.addColorStop(0.2, 'rgba(255, 255, 255, 1)');   // Stays solid until only 20% out
      gradient.addColorStop(0.6, 'rgba(255, 255, 255, 0)');   // Completely faded out by 60% out
